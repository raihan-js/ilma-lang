        ...
        provideCompletionItems: (model, position) => {
            ...
            const items = [
                ...
                ...[
                    ...
                    ['web.listen', 'web.listen(${1:3000})', 'Start web server on port'],
                    ['web.accept', 'web.accept()', 'Accept next HTTP request'],
                    ['web.path', 'web.path()', 'Get request path'],
                    ['web.method', 'web.method()', 'Get HTTP method'],
                    ['web.query', 'web.query("${1:key}")', 'Get query parameter'],
                    ['web.html', 'web.html(${1:content})', 'Build HTML response'],
                    ['web.json', 'web.json(${1:data})', 'Build JSON response'],
                    ['web.send', 'web.send(${1:response})', 'Send response to client'],
                    ['web.status', 'web.status(${1:404})', 'Set HTTP status code'],
                    ['web.redirect', 'web.redirect("${1:url}")', 'Send redirect response'],
                ].map(([label, insert, doc]) => ({
